...
from plume import SelectQuery


class TestSQLSelection:

    def test_select_non_indexed_field(self):
        select_query = SelectQuery('users', set([]), {
            'name': {'$eq': 'John'}
        })
    ...
    def test_select_indexed_text_field(self):
        select_query = SelectQuery('users', set(['name']), {
            'name': {'$eq': 'John'}
        })
    ...
    def test_select_indexed_integer_field(self):
        select_query = SelectQuery('users', set(['age']), {
            'age': {'$eq': 42}
        })
    ...
    def test_select_indexed_float_field(self):
        select_query = SelectQuery('users', set(['size']), {
            'size': {'$eq': 1.66}
        })
